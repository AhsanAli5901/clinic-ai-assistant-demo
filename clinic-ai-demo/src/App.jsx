  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
      ...
      <section
        style={{
          background:
            "linear-gradient(135deg, #0a3d2e 0%, #0f6c3d 60%, #1a9e5a 100%)",
          color: "#fff",
        ...
        >
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
              ...
              <path d="M12 0C5.373 0 0 5.373 0 12c0 2.083.532 4.043 1.465 5.748L.036 23.845a.5.5 0 0 0 .62.619l6.179-1.416A11.943 11.943 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22a9.954 9.954 0 0 1-5.127-1.414l-.368-.217-3.812.874.891-3.713-.239-.383A9.96 9.96 0 0 1 2 12C2 6.478 6.478 2 12 2s10 4.478 10 10-4.478 10-10 10z" />
            </svg>
            WhatsApp Us
          </a>
        </div>
          ...
          {CLINIC_CONFIG.services.map((s) => (
            <div
              ...
              style={{
                ...
                borderRadius: 20,
                padding: "32px 24px",
                boxShadow: "0 2px 20px rgba(10,61,46,0.07)",
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  "0 8px 32px rgba(10,61,46,0.14)";
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = "";
                e.currentTarget.style.boxShadow =
                  "0 2px 20px rgba(10,61,46,0.07)";
              }}
            >
        ...
        >
          <div
            style={{
              ...
              height: 110,
              borderRadius: "50%",
              background: "linear-gradient(135deg, #0f6c3d, #1a9e5a)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              fontSize: 48,
          ...
          <div>
            ...
            <p style={{ color: "#0f6c3d", fontWeight: 600, marginBottom: 10 }}>
              {CLINIC_CONFIG.doctor.title} · {CLINIC_CONFIG.doctor.experience}
            </p>
            <p style={{ color: "#6b7280", lineHeight: 1.7, fontSize: 15 }}>
              {CLINIC_CONFIG.doctor.bio}
            </p>
          </div>
        </div>
      </section>
        ...
        >
          <div
            style={{
              ...
              borderRadius: 20,
              padding: "32px",
              boxShadow: "0 2px 16px rgba(10,61,46,0.07)",
            }}
          >
            <h3
              style={{
            ...
            {CLINIC_CONFIG.timings.map((t, i) => (
              <div
                ...
                style={{
                  ...
                  padding: "10px 0",
                  borderBottom:
                    i < CLINIC_CONFIG.timings.length - 1
                      ? "1px solid #e8f5f0"
                      : "none",
                }}
              >
                ...
                <span
                  style={{
                    color: t.hours === "Closed" ? "#ef4444" : "#0f6c3d",
                    fontWeight: 600,
                  }}
                >
                  {t.hours}
          ...
          >
            ...
            <p style={{ color: "#0f6c3d", fontWeight: 600, marginTop: 16 }}>
              📞 {CLINIC_CONFIG.phone}
            </p>
          </div>
        </div>
      ...
      <section
        style={{
          padding: "64px 24px",
          background: "linear-gradient(135deg, #0a3d2e, #0f6c3d)",
          color: "#fff",
          textAlign: "center",
        }}
      >
        ...
        <h2 style={{ fontSize: 32, fontWeight: 800, marginBottom: 48 }}>
          Stop Missing Patients. Start Growing.
        </h2>
        <div
          style={{
            display: "grid",
          ...
          {[
            {
              ...
              desc: "Every patient request is captured automatically",
            },
            {
              icon: "💬",
              title: "Auto WhatsApp Replies",
              desc: "Instant confirmation messages without staff effort",
            },
            {
              icon: "📋",
              title: "Organised Records",
              desc: "All appointments in one clean dashboard",
            },
            {
              icon: "⭐",
              title: "Professional Image",
              desc: "Impress patients with modern booking experience",
            },
            {
              icon: "⏰",
              title: "Save Staff Time",
              desc: "Reduce manual calls and paperwork significantly",
            },
          ].map((b, i) => (
            <div
              key={i}
      ...
      >
        ...
        <p>
          {CLINIC_CONFIG.address} · {CLINIC_CONFIG.phone}
        </p>
        <p style={{ marginTop: 16, fontSize: 12 }}>
          © 2025 {CLINIC_CONFIG.name}. All rights reserved.
        </p>
      </footer>
    </div>
  );
      ...
      >
        ...
        <div style={{ padding: 32 }}>
          ...
          {step === 1 && (
            <div>
              <h3
                style={{ fontWeight: 700, color: "#0a3d2e", marginBottom: 24 }}
              >
                Patient Information
              </h3>
              {[
              ...
              >
                {CLINIC_CONFIG.services.map((s) => (
                  <button
                    ...
                    style={{
                      background:
                        form.service === s.label ? "#0a3d2e" : "#f8fffe",
                      color: form.service === s.label ? "#fff" : "#374151",
                      border: `2px solid ${form.service === s.label ? "#0a3d2e" : "#e8f5f0"}`,
                      borderRadius: 16,
                      padding: "20px 16px",
                      cursor: "pointer",
                      textAlign: "center",
          ...
          {step === 3 && (
            <div>
              <h3
                style={{ fontWeight: 700, color: "#0a3d2e", marginBottom: 20 }}
              >
                Select Date
              </h3>
              <div
              ...
              >
                {dates.map((d) => (
                  <button
                    ...
                    style={{
                      background: form.date === d ? "#0a3d2e" : "#f8fffe",
                      color: form.date === d ? "#fff" : "#374151",
                      border: `2px solid ${form.date === d ? "#0a3d2e" : "#e8f5f0"}`,
                      borderRadius: 12,
                      padding: "10px 16px",
                      cursor: "pointer",
                      fontSize: 13,
              ...
              <h3
                style={{ fontWeight: 700, color: "#0a3d2e", marginBottom: 16 }}
              >
              ...
              >
                {CLINIC_CONFIG.timeSlots.map((t) => (
                  <button
                    ...
                    style={{
                      background: form.time === t ? "#0f6c3d" : "#f8fffe",
                      color: form.time === t ? "#fff" : "#374151",
                      border: `2px solid ${form.time === t ? "#0f6c3d" : "#e8f5f0"}`,
                      borderRadius: 12,
                      padding: "14px",
                      cursor: "pointer",
                      fontWeight: 700,
          ...
          {step === 4 && (
            <div style={{ textAlign: "center" }}>
              ...
              <p style={{ color: "#6b7280", marginBottom: 28 }}>
                We'll confirm your slot shortly via WhatsApp.
              </p>
              <div
                style={{
                  background: "#f8fffe",
...
function WhatsAppSim({ booking }) {
  const msgs = [
    {
      delay: 400,
      text: "Assalam o Alaikum! 👋 Thank you for contacting Prime Physio Clinic.",
    },
    {
      delay: 1200,
      text: "Your appointment request has been received successfully.",
    },
    ...
    {
      delay: 4600,
      text: "Our team will confirm your slot shortly. Please arrive 10 minutes early. 🙏",
    },
  ];
      ...
      >
        ...
        <div
          style={{
            ...
            overflowY: "auto",
            backgroundImage:
              "url(\"data:image/svg+xml,%3Csvg width='60' height='60' xmlns='http://www.w3.org/2000/svg'%3E%3C/svg%3E\")",
          }}
        >
          {/* Intro bubble */}
...
function AdminDashboard({ newBooking }) {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: patients.filter((p) => p.date === "Today").length,
      icon: "📅",
      color: "#2563eb",
    },
    {
      label: "Missed Avoided",
      value: patients.length,
      icon: "✅",
      color: "#7c3aed",
    },
  ...
  return (
    <div style={{ padding: "32px 24px", maxWidth: 1100, margin: "0 auto" }}>
      <div style={{ marginBottom: 32 }}>
        <h2 style={{ fontWeight: 800, fontSize: 28, color: "#0a3d2e" }}>
          Admin Dashboard
        </h2>
      ...
      >
        ...
        >
          <h3 style={{ fontWeight: 700, color: "#0a3d2e" }}>
                ...
                return (
                  <tr
                    ...
                    style={{
                      ...
                      background:
                        i === 0 && newBooking ? "rgba(15,108,61,0.03)" : "#fff",
                    }}
                  >
                    ...
                    <td style={{ padding: "14px 16px" }}>
                      ...
                      >
                        ...
                        <button
                          onClick={() => updateStatus(p.id, "Follow-up Needed")}
                          style={{
                            background: "#fef9c3",
                            color: "#a16207",
                            border: "none",
    ...
    >
      ...
      <nav
        style={{
          ...
          top: 0,
          zIndex: 100,
          boxShadow: "0 2px 12px rgba(10,61,46,0.06)",
        }}
      >
        <div style={{ fontWeight: 800, fontSize: 18, color: "#0a3d2e" }}>
          🏥 {CLINIC_CONFIG.name}
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          <button
            ...
            style={{
              background: view === "landing" ? "#e8f5f0" : "transparent",
              border: "none",
              borderRadius: 8,
              padding: "8px 16px",
              fontWeight: 600,
          ...
          <button
            ...
            style={{
              background: view === "admin" ? "#e8f5f0" : "transparent",
              border: "none",
              borderRadius: 8,
              padding: "8px 16px",
              fontWeight: 600,
      ...
      {/* Views */}
      {view === "landing" && (
        <LandingPage onBook={() => setShowBooking(true)} />
      )}
      ...
      {view === "booking-done" && booking && (
        <div style={{ padding: "40px 24px", maxWidth: 900, margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: 16 }}>
            ...
            <p style={{ color: "#6b7280" }}>
              Here's your WhatsApp-style confirmation preview
            </p>
          </div>
